...
const Pricing = () => {
  const headingText = "Choose the Perfect Plan".split(" ");
  const content =
    "We offer flexible pricing plans that align with where your business stands today and where it's headed.".split(
      " "
    );
