...
const Comparison = () => {
  const headingText = "Our Value vs. Competitor Value".split(" ");
  const content =
    "Compare our SaaS to the competition and discover how we offer better value, more savings, and greater flexibility for your business.".split(
      " "
    );
  ...
  return (
    <div className="bg-gradient-to-b from-[#F4FFDF] to-white relative py-16 px-4 lg:px-32">
      ...
      <motion.div
        className="max-w-4xl mx-auto bg-white p-0.5 border border-white rounded-lg"
      ...
      >
        <div className="grid grid-cols-3 md:grid-cols-4 text-center">
          <div className="font-medium bg-[#F7F8F5] py-5 rounded-tl-lg px-4">
            FEATURES
          </div>
          ...
          <div className="hidden md:block font-medium bg-[#F7F8F5] py-5 rounded-tr-lg px-4">
            Proeco
          </div>
          {features.map((feature, index) => (
            <React.Fragment key={index}>
              <div className="flex items-center justify-center py-7 text-xs font-[550] px-4 border-t border-gray-200">
                {feature.name}
              </div>
              <div className="py-6 px-4 border-t border-gray-200 text-base md:text-xl">
                {feature.clover}
              </div>
              <div className="py-6 px-4 border-t border-gray-200 font-semibold text-base md:text-xl">
                {feature.nectar}
              </div>
              <div className="hidden md:block py-6 px-4 border-t border-gray-200 font-semibold text-base md:text-xl">
                {feature.proeco}
              </div>
            </React.Fragment>
          ))}
